...
KISBPM.URL = {
    ...
    getModel: function(modelId) {
    	console.info(ACTIVITI.CONFIG.contextRoot + '/model/' + modelId + '/json')
    ...
    getUser: function(){
    	return ACTIVITI.CONFIG.contextRoot + '/model/user';
    },
    getGroup: function(){
    	return ACTIVITI.CONFIG.contextRoot + '/model/group';
    }
